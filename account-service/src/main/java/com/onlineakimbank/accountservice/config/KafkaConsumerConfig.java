...
import com.onlineakimbank.accountservice.event.card.CardRegistrationEvent;
import com.onlineakimbank.accountservice.event.card.CardRemoveEvent;
import com.onlineakimbank.accountservice.event.card.CardStatusChangeEvent;
import com.onlineakimbank.accountservice.event.user.UserRegistrationEvent;
import com.onlineakimbank.accountservice.event.user.UserRemoveEvent;
import com.onlineakimbank.accountservice.event.user.UserUpdateEvent;
