package com.onlineakimbank.loanservice.exception;

import com.onlineakimbank.cardservice.exception.EntityNotFoundException;
import com.onlineakimbank.cardservice.exception.ErrorDetails;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> handleCardNotFoundException(Exception e,
                                                                        WebRequest request) {
